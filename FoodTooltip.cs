/*
 * Fridge Organization Game - FoodTooltip.cs
 * 
 * Author: Zixuan Wang
 * 
 * Description: Specialized tooltip component for food items that provides detailed information
 * about proper storage, temperature requirements, and food safety guidelines. Enhances the
 * educational value by delivering contextual learning content.
 * 
 * Key Responsibilities:
 * - Food-specific tooltip content management
 * - Storage guideline and temperature requirement display
 * - Educational content delivery for food safety
 * - Integration with food item hover detection
 * - Contextual learning support and guidance
 */
